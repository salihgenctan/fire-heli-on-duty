class CannonHelper{
    ...
    addVisual(body, color=0x888888, name="mesh", castShadow=true, receiveShadow=true){
        ...
        const material = (color==0x888888) ? this.defaultMaterial : new THREE.MeshLambertMaterial({color:color, transparent: true,opacity: 0.6});
        ...
        body.shapes.forEach (function(shape){
            ...
            switch(shape.type){
                ...
                case CANNON.Shape.types.BOX:
                    ...
                    mesh = new THREE.Mesh( box_geometry, new THREE.MeshLambertMaterial({color: 0xeb2af5 ,transparent: true,opacity: 0.02}) );
                    break;
